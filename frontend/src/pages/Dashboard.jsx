        ...
        <div className="w-64 h-full flex flex-col justify-between">
          <div className="p-6">
            ...
            <nav className="space-y-2">
              <Link to="/" className="flex items-center gap-3 px-4 py-3 bg-red-500/10 text-red-500 border border-red-500/20 rounded-xl font-medium shadow-[0_0_15px_rgba(239,68,68,0.1)] transition-colors">
